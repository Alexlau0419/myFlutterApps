...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Coway.com',
      home: const TicToctoeDemo(),
    );
  }
}

class TicToctoeDemo extends StatefulWidget {
  const TicToctoeDemo({super.key});

  @override
  State<TicToctoeDemo> createState() => _TicToctoeDemoState();
}

class _TicToctoeDemoState extends State<TicToctoeDemo> {
  // Create a 3x3 board
